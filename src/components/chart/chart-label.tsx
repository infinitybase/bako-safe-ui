          ...
          {hasActiveItem ? (
            <g key="active-items">
              ...
              <motion.text
                ...
                initial={{ opacity: 0, x: viewBox.cx, y: viewBox.cy }}
                animate={{
                  opacity: 1,
                  x: viewBox.cx,
                  y: viewBox.cy - (fontSize / 2 + gap + smallFontSize / 2),
                }}
                exit={{ opacity: 0, x: viewBox.cx, y: viewBox.cy }}
              ...
              <motion.text
                ...
                initial={{ opacity: 0, x: viewBox.cx, y: viewBox.cy }}
                animate={{ x: viewBox.cx, y: viewBox.cy, opacity: 1 }}
                exit={{ opacity: 0, x: viewBox.cx, y: viewBox.cy }}
                transition={{ duration: 0.3, ease: 'easeInOut' }}
              >
                {title}
